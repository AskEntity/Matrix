...
- **Cache Engineering** — Frozen tools, byte-identical JSONL reconstruction, fork prefix sharing. Ten concurrent 800K sessions, near-zero cache creation on restart.
- **Two Layers of Reality** — Tests ground AI in physical reality (code works or doesn't). Tasks ground AI in human reality (decisions and their reasoning). Together, they close the gap between AI capability and AI reliability.
...
- [Why Matrix](https://matrix.dev/why) — The real gap, cache moat, self-bootstrapping, competitive positioning
