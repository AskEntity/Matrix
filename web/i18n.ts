...
const en: Translations = {
	...
	"settings.cacheTtl5m": "5 min",
	"settings.cacheTtl1hDefault": "1 hour (default)",
	"settings.cacheTtl5mDefault": "5 min (default)",
...
const zh: Translations = {
	...
	"settings.cacheTtl5m": "5 分钟",
	"settings.cacheTtl1hDefault": "1 小时（默认）",
	"settings.cacheTtl5mDefault": "5 分钟（默认）",
