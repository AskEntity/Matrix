...
const en: Translations = {
	...
	"tasks.agentWorking": "Agent is working…",
	...
	"settings.defaultAuth": "Default Auth Group",
	"settings.childAuth": "Child Auth Group",
...
const zh: Translations = {
	...
	"settings.defaultAuth": "默认认证组",
	"settings.childAuth": "子代理认证组",
