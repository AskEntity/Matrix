...
/** Minimize — arrows pointing inward (exit fullscreen) */
export function IconMinimize({ size = 14 }: { size?: number }) {
	return (
		<svg
			aria-hidden="true"
			width={size}
...
export function IconBack({ size = 12 }: { size?: number }) {
	return (
		<svg
			aria-hidden="true"
			width={size}
...
export function IconSidebarLeft({ size = 14 }: { size?: number }) {
	return (
		<svg
			aria-hidden="true"
			width={size}
