...
export type Event = (
	 ...
	 * Used for parent-chain rollback infrastructure (future).
	 */
	eid?: string;

	/**
	 * eid of the preceding event in this JSONL file, or null for the first event.
	 * Auto-generated by EventStore on append — callers never set this.
	 * Forms a linear chain: every event points to the one before it.
	 * Future: rollback/branch will use parentEid to point to a branch point.
	 */
