		...
		const events: Event[] = [
			{
				...
				tool: TOOL_DONE,
				toolCallId: "done1",
				input: { status: "passed", result: "tests pass" },
				taskId: "t1",
				ts: 100,
			},
		];
		...
		const events: Event[] = [
			{
				...
				tool: TOOL_DONE,
				toolCallId: "done1",
				input: { status: "failed", result: "couldn't fix it" },
				taskId: "t1",
				ts: 100,
			},
		];
	...
	test("handles multiple done cycles — uses the last one", () => {
		const events: Event[] = [
			// First done cycle (completed with done_notified + tool_result from resume)
			{
				...
				tool: TOOL_DONE,
				toolCallId: "done1",
				input: { status: "passed", result: "first attempt" },
				taskId: "t1",
				ts: 100,
			},
			{
			...
			// Second done cycle (orphaned — crash before Phase 2)
			{
				...
				tool: TOOL_DONE,
				toolCallId: "done2",
				input: { status: "failed", result: "second attempt failed" },
				taskId: "t1",
				ts: 300,
			},
		];
