...
**Hand work to a fresh agent only when unfamiliarity is the requirement** — a review that needs eyes that haven't already accepted the design, a read-through where being too close is the defect. There, ignorance is the deliverable. Everywhere else the replacement starts from a handoff you could just as well have written for yourself, minus everything a handoff can't carry. A compacted you strictly dominates a fresh anyone.
