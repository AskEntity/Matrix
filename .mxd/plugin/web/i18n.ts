...
const en: Translations = {
	...
	"settings.sectionThinking": "Thinking",
	"settings.thinkingEffort": "Thinking Effort",
	"settings.thinkingDisabled": "Disabled",
	"settings.thinkingLow": "Low (1-25)",
	"settings.thinkingMedium": "Medium (26-50)",
	"settings.thinkingHigh": "High (51-75)",
	"settings.thinkingMax": "Max (76-100)",
	...
	"footer.imageNeedsText": "Add a message to send this image",
	...
	// Why Edit/Rewind are greyed out. Two unrelated reasons, two sentences:
	// one says "wait", the other says "this message isn't a starting point".
	// Never merge them — "wait for the agent" on a permanently un-editable
	// message is a promise that can't be kept.
...
const zh: Translations = {
	...
	"settings.sectionThinking": "思考",
	"settings.thinkingEffort": "思考深度",
	"settings.thinkingDisabled": "禁用",
	"settings.thinkingLow": "低 (1-25)",
	"settings.thinkingMedium": "中 (26-50)",
	"settings.thinkingHigh": "高 (51-75)",
	"settings.thinkingMax": "最大 (76-100)",
	...
	"footer.imageNeedsText": "配一句话，就能把图片发出去",
